...
# This is the model instantiated for the Go2 Flat Managed Environment
# isaaclab -p scripts/reinforcement_learning/skrl/play.py --task Isaac-Velocity-Flat-Unitree-Go2-v0 --num_envs 32 
